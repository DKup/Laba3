...
public class NewMainFraime  extends JFrame{
...
private VisualTop renderer = new VisualTop();
// Модель данных с результатами вычислений
private Table data;

    

public NewMainFraime(Double[] coefficients) {
...
// Показать диалоговое окно
    if (fileChooser.showSaveDialog(NewMainFraime.this) ==JFileChooser.APPROVE_OPTION)
...
String value =JOptionPane.showInputDialog(NewMainFraime.this,
...
data = new Table(from, to, step,
NewMainFraime.this.coefficients);
...
JOptionPane.showMessageDialog(NewMainFraime.this,
...
NewMainFraime frame = new NewMainFraime(coefficients);
